...
protected:
	...
	//CWE addition, "global" config, the only point of the section/category crap
	//is the xml
	//duplicate info, but it will be freed after init anyways, performance loss is probably tiny
	std::unordered_map<std::string, std::string> m_globalGroup;
};
