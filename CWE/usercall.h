...
static constexpr T const GenerateUsercallWrapper(int ret, intptr_t address, TArgs... args)
{
...
template<typename T, typename... TArgs>
static constexpr void const GenerateUsercallHook(T func, int ret, intptr_t address, TArgs... args)
{
	const size_t argc = sizeof...(TArgs);
	int argarray[] = { args... };
	int stackcnt = 0;
