...
NJS_CNK_OBJECT* ObjectRegistry::GetObj(int index)const {
...
void ObjectRegistry::Set(int index, NJS_CNK_OBJECT* obj) {
	if (!obj) return;
...
void ObjectRegistry::Add(NJS_CNK_OBJECT* obj, NJS_TEXLIST* tex) {
	if (!obj || !tex) {
