...
DataPointer(CCL_INFO, ALO_LobbyGateDarkExecutor_collision, 0x122C028);
DataPointer(CCL_INFO, ALO_LobbyGate_collision, 0x123F070);
DataPointer(CCL_INFO, ALO_LobbyGateKinderExecutor_collision, 0x12562E0);
...
DataPointer(CCL_INFO*, ChaoCollisionData, 0x13134D0);
DataPointer(int, ChaoOldStageNumber, 0x13402AC);
DataPointer(int, ChaoStageNumber, 0x134046C);
DataPointer(int, ChaoNextStageNumber, 0x134062C);
DataArray(CHAO_GARDEN_INFO, GardenInfoList, 0x019F6460, 2);
...
DataPointer(char, ucMinutes, 0x174AFDB);
DataPointer(char, ucSeconds, 0x174AFDC);
DataPointer(char, ucFrames, 0x174AFDD);
...
DataPointer(OBJ_LANDTABLE *, pObjLandTable, 0x19459DC);
DataPointer(task *, LandManagerPtr, 0x1945A04);
DataPointer(int, ALO_EntranceLampManager_ptr, 0x1A2771C);
DataPointer(int, SomeObjectPointers_Index, 0x1A2835C);
DataPointer(task **, SomeObjectPointers, 0x1A28360);
...
DataArray(task *, VibTasks, 0x1A5588C, 4);
...
DataPointer(task *, Super_ManTex_ptr, 0x1A5A42C);
...
DataPointer(task *, StageMapExecInstance, 0x1AEE758);
DataPointer(task *, RingModelExec_ptr, 0x1AEFD88);
DataPointer(int, ExpManExec_ptr, 0x1AEFDB0);
DataPointer(task **, itemBoxManager_ptrs, 0x1AEFE98);
DataPointer(task *, FogTaskExec_ptr, 0x1AEFEA0);
DataPointer(FogData *, FogDataPtr, 0x1AEFEA4);
DataPointer(task *, FogtaskManExec_ptr, 0x1AEFEB4);
DataPointer(task *, PauseHintExec_ptr, 0x1AEFF60);
DataPointer(task *, ChaoKeyTaskObj, 0x1AEFF64);
DataPointer(task *, PosBar2PMan_ptr, 0x1AF0148);
DataPointer(task *, ObjSetManExec_ptr, 0x1AF0208);
...
DataPointer(OBJ_LANDTABLE, BasicLandTable, 0x1DDA3C0);
DataPointer(OBJ_LANDTABLE, ChunkLandTable, 0x1DDA3E0);
...
DataArray(int, SWDATAE, 0x1DEFAB0, 2);
