...
MOTION_TABLE alm_dance_h = { &motion_alm_dance_h ,  1, 0, 0xFFFFFFFF, -40, 0.0f, 30.0f, 0.12f };
MOTION_TABLE alm_dance_d = { &motion_alm_dance_d,	 1, 0, 0xFFFFFFFF, -40, 0.0f, 34.0f, 0.12f };
MOTION_TABLE alm_guitar = { &motion_alm_guitar ,   1, 0, 0xFFFFFFFF, -40, 0.0f, 10.0f, 0.12f * 2 };
MOTION_TABLE alm_float = { &motion_alm_float  ,   1, 0, 0xFFFFFFFF, -40, 0.0f, 14.0f, 0.12f * 2 };
MOTION_TABLE alm_duck = { &motion_alm_duck  ,    1, 0, 0xFFFFFFFF, -40, 0.0f, 13.0f, 0.12f * 2 };
MOTION_TABLE alm_wrench_start = { &motion_alm_wrench,    6, 0, 0xFFFFFFFF, -40, 9, 18, 0.15 };
MOTION_TABLE alm_wrench_start2 = { &motion_alm_wrench,    6, 0, 0xFFFFFFFF, -40, 18, 28, 0.15 };
MOTION_TABLE alm_wrench = { &motion_alm_wrench,    7, 0, 0xFFFFFFFF, -40, 28, 36, 0.15 };
